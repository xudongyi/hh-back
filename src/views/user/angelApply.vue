<template>
  <div class="angel-container">
    ...
    <el-table :data="responseData.data" border style="width: 100%">
      ...
      <el-table-column prop="applyTime" label="申请日期" :formatter="formatterTime" show-overflow-tooltip
      ...
      <el-table-column prop="brand" label="代理品牌" show-overflow-tooltip width="120"></el-table-column>
      <el-table-column prop="APPLY_FEE" label="代理费用"></el-table-column>
      <el-table-column prop="remark" label="备注" v-if="yc"></el-table-column>
      <el-table-column prop="APPLY_STATUS" label="申请审核">
        <template scope="scope">
          <div v-if="scope.row.APPLY_STATUS== 1" style="color:#4189DC;cursor:pointer;" @click="getInfo(scope.row)">待审核
          </div>
      ...
      <el-table-column prop="PAY_STATUS" label="付款审核" :formatter="payStatus">
        <template scope="scope">
          <div v-if="scope.row.PAY_STATUS== 2" style="color:#4189DC;cursor:pointer;" @click="getInfo1(scope.row)">待审核
          </div>
    ...
    <el-dialog title="代理申请审核" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        <el-col :span="12">
        ...
        <el-col :span="12">
          ...
          <el-form-item label="代理品牌" :label-width="formLabelWidth">
            <el-input disabled v-model="form.brand" auto-complete="off"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="代理费用" :label-width="formLabelWidth">
    ...
    <el-dialog title="凭证信息" :visible.sync="dialogFormVisible2" width="500px">
      <img :src="imgFile" alt="" style="width: 100%;height: 100%">
      <div slot="footer" class="dialog-footer">
...
<script>
  import {getAngelApplyList, getApplyFile, saveApplyState, savePayState} from "@/api/apply";
